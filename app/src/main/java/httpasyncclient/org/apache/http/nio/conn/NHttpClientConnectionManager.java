 ...
 *
 */
package httpasyncclient.org.apache.http.nio.conn;
...
public interface NHttpClientConnectionManager {
     ...
     * by calling {@link #startRoute(NHttpClientConnection,
     *   HttpRoute,
     *   HttpContext) startRoute} in order to start
     * the process of connection initialization, optionally calling
     * {@link #upgrade(NHttpClientConnection,
     *   HttpRoute,
     ...
     * {@link #routeComplete(NHttpClientConnection,
     *   HttpRoute,
     ...
     * the {@link #routeComplete(NHttpClientConnection,
     *   HttpRoute,
     *   HttpContext) routeComplete} method must be called.
     *
