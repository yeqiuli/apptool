...
class MinimalHttpAsyncClient extends CloseableHttpAsyncClientBase {
    ...
    public <T> Future<T> execute(
        ...
        @SuppressWarnings("resource") final MinimalClientExchangeHandlerImpl<T> handler = new MinimalClientExchangeHandlerImpl<T>(
                this.log,
                requestProducer,
                responseConsumer,
                localcontext,
    ...
    public <T> Future<List<T>> execute(
        ...
        final HttpClientContext localcontext = HttpClientContext.adapt(
                context != null ? context : new BasicHttpContext());
        @SuppressWarnings("resource") final PipeliningClientExchangeHandlerImpl<T> handler = new PipeliningClientExchangeHandlerImpl<T>(
                this.log,
                target,
                requestProducers,
                responseConsumers,
