package httpcore.org.apache.http.ssl;
...
import httpclient.org.apache.http.conn.ConnectTimeoutException;
import httpclient.org.apache.http.conn.HttpInetSocketAddress;
import httpclient.org.apache.http.conn.scheme.HostNameResolver;
import httpclient.org.apache.http.conn.scheme.LayeredSchemeSocketFactory;
import httpclient.org.apache.http.conn.scheme.LayeredSocketFactory;
import httpclient.org.apache.http.conn.scheme.SchemeLayeredSocketFactory;
import httpclient.org.apache.http.conn.socket.LayeredConnectionSocketFactory;
import httpclient.org.apache.http.conn.ssl.AllowAllHostnameVerifier;
import httpclient.org.apache.http.conn.ssl.BrowserCompatHostnameVerifier;
import httpclient.org.apache.http.conn.ssl.StrictHostnameVerifier;
...
public class SSLSocketFactory implements LayeredConnectionSocketFactory, SchemeLayeredSocketFactory,
    ...
    public SSLSocketFactory(
            final KeyStore truststore)
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        this(SSLContexts.custom().loadTrustMaterial((TrustStrategy) truststore).build(),
                BROWSER_COMPATIBLE_HOSTNAME_VERIFIER);
    }
