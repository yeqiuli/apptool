...
public class SignUtil {
    ...
    public static String sign(String secret, String method, String path,
        ...
        try {
            ...
            return new String(Base64.encodeBase64(hmacSha256.doFinal(buildStringToSign(method, path, headers, querys, bodys, signHeaderPrefixList).getBytes(Constants.ENCODING))), Constants.ENCODING);
        } catch (Exception e) {
