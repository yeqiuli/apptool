...
import com.yct.shaobingsdk.helper.HealthCheckHelper;
import com.yct.shaobingsdk.helper.SaoBingCallBack;
 ...
 * 羊城通测试
 */
public class TestYctAty extends BaseAty {
    ...
    private void initYct() {
        HealthCheckHelper.getInstance().init("", "", "", "", this, new SaoBingCallBack() {
            @Override
            public void onInitScan(boolean b, String s) {

            }

            @Override
            public void onFailedThrow(String s, String s1) {

            }

            @Override
            public void onEnableMessageNotice(String s) {
