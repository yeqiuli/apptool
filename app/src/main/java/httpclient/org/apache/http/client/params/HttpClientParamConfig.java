...
import httpclient.org.apache.http.auth.params.AuthPNames;
import httpclient.org.apache.http.client.config.RequestConfig;
import httpclient.org.apache.http.conn.params.ConnRoutePNames;
import httpcore.org.apache.http.HttpHost;
import httpcore.org.apache.http.params.CoreConnectionPNames;
import httpcore.org.apache.http.params.CoreProtocolPNames;
...
/**
 * @deprecated (4.3) provided for compatibility with {@link org.apache.http.params.HttpParams}. Do not use.
 *
 * @since 4.3
 */
@Deprecated
    ...
    public static RequestConfig getRequestConfig(final HttpParams params, final RequestConfig defaultConfig) {
        final RequestConfig.Builder builder = RequestConfig.copy(defaultConfig)
                .setSocketTimeout(params.getIntParameter(
                        org.apache.http.params.CoreConnectionPNames.SO_TIMEOUT, defaultConfig.getSocketTimeout()))
                .setStaleConnectionCheckEnabled(params.getBooleanParameter(
                        org.apache.http.params.CoreConnectionPNames.STALE_CONNECTION_CHECK, defaultConfig.isStaleConnectionCheckEnabled()))
