...
import httpclient.org.apache.http.conn.util.InetAddressUtils;
...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    public final void verify(
        ...
        verify(host, cn != null ? new String[]{cn} : null, subjectAlts != null && !subjectAlts.isEmpty() ? subjectAlts.toArray(new String[subjectAlts.size()]) : null);
    }
